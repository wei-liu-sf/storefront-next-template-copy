...
import * as CustomerProfileFormStories from './index.stories';
import { render, cleanup } from '@testing-library/react';

const composed = composeStories(CustomerProfileFormStories);

afterEach(() => {
    cleanup();
});

describe('CustomerProfileForm stories snapshot', () => {
