...
import * as CheckoutFormPageStories from './checkout-form-page.stories';
...
const composed = composeStories(CheckoutFormPageStories);

afterEach(() => {
    cleanup();
});

describe('CheckoutFormPage stories snapshot', () => {
